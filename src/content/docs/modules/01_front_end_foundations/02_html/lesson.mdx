...
slug: "modules/01_front_end_foundations/02_html/lesson"
---
...
<div style="display: grid; gap: 20px; margin: 20px 0; color: #666;">
...
```
  ...
  <div style="border: 2px solid #4CAF50; padding: 15px; background: #e8f5e9; border-radius: 8px; color: #666;">
    ...
    <article style="background: white; padding: 12px; margin-top: 10px; border-radius: 4px;">
      <h2 style="margin: 0 0 8px 0; color: #666;">My Day</h2>
...
1. **Open DevTools**
   ...
   - Or press `F12` or `Cmd+Option+I` (Mac only)
...
3. **Inspect the Generic Div Example**
   ...
   - **Click the Accessibility icon** (the little person) in the top-right corner of the side panel to view the accessibility tree.
   
     ![Accessibility Icon Location](/images/modules/02_html/accessibility_icon.png)

   - Look at the Accessibility panel - you'll see it's labelled as "Ignored" or just "GenericContainer" with no semantic meaning.
   
     ![Generic Accessibility Tree](/images/modules/02_html/semantic_tree_bad.png)
...
4. **Inspect the Semantic Article Example**
   ...
   - The `<h2>` inside is recognized as a **heading level 2**
     ...
     ![Semantic Accessibility Tree](/images/modules/02_html/semantic_tree_good.png)
...
5. **View the Accessibility Tree**
   ...
   - Compare how the generic divs appear (Ignored/StaticText) vs. the semantic elements (Article/Heading)
...
<div style="padding: 20px; background: #f5f5f5; border-radius: 8px; margin: 20px 0; color: #666;">
  <h1 style="margin: 10px 0; color: #666;">h1: Main Page Title</h1>
  <h2 style="margin: 10px 0; color: #666;">h2: Major Section</h2>
  <h3 style="margin: 10px 0; color: #666;">h3: Subsection</h3>
  <h4 style="margin: 10px 0; color: #666;">h4: Sub-subsection</h4>
  <h5 style="margin: 10px 0; color: #666;">h5: Minor Heading</h5>
  <h6 style="margin: 10px 0; color: #666;">h6: Smallest Heading</h6>
  <p style="margin: 10px 0; color: #666;">p: Regular paragraph text for comparison</p>
</div>
...
- `<img src="..." alt="...">`: Embeds an image.
  ...
  - `<img src="https://timsexperiments.foo/logo.svg" alt="Tim's Experiments Logo">`
